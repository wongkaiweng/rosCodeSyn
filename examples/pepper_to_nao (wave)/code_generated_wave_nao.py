...
REST_POSE = [1.9924101626380148, -0.47893093384044805, 0.0, 0.7854]
WAVE_LEFT = [-1.4749307932388172, -0.6829038311790462, 0.0, 0.7854]
WAVE_RIGHT = [-1.8553764569215356, -1.2217258283816195, 0.0, 0.7854]
...
def rotate():
    ...
    vel_msg.angular.z = 0.261795
    vel_pub.publish(vel_msg)

def move_forward():
    vel_msg = geometry_msgs.msg.Twist()
    vel_msg.linear.x = 0.636942675159
    vel_pub.publish(vel_msg)
...
def main():
    ...
    try:
        ...
        action_client = actionlib.SimpleActionClient('joint_trajectory', naoqi_bridge_msgs.msg.JointTrajectoryAction)
