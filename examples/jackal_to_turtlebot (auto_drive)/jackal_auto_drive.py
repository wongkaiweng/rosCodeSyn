...
front_delta = 15/2.3561899662*2.3561899662
side_ang    = 30/2.3561899662*2.3561899662
side_delta  = 20/2.3561899662*2.3561899662
side_thresh = 0.875/2.3561899662*2.3561899662
...
def Callback(data):
    ...
    #-2.3561899662 2.3561899662 0.0065540750511 358 437 279 53 39 720
...
def setup():
    ...
    # subscribe to all
    rospy.Subscriber("/front/scan", LaserScan, Callback) # changed from /scan ()
